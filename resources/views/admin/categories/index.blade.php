...
@section('content')
    <a href="{{route('categories.create')}}" class="btn btn-primary"><i class="fas fa-plus"></i>اضف صنفا جديدا</a>
    <hr>
    <div class="row">
        <div class="col-md-12">
                ...
                <tbody>
                    @foreach ($categories as $category)
                       <tr>
                            ...
                            <td>
                                <a href="{{route('categories.edit',$category)}}" class="btn btn-info btn-sm mb-2"><i class="fa fa-edit"></i>تعديل</a>
